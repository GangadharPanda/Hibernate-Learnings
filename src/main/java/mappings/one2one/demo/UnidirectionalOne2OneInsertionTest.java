...
public class UnidirectionalOne2OneInsertionTest {
	public static void main(String[] args) {
		...
		InstructorDetails details = new InstructorDetails(null, "YouTube URL", "LinkedIn URL");

		// Create Instructor Object
		Instructor instructor = new Instructor(null, "Chad", "Darby", "chad.darby@luv2code.com", details);
