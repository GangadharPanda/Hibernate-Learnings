package _09PersistingACollectionOfObjectWithPK.demo;
...
public class PersistingACollectionOfObjectDemo {
	...
	public static void main(String[] args) {
		...
		SessionFactory factory = new Configuration().configure("hibernate.cfg-create.xml")
				.addAnnotatedClass(EmployeeHavePrimaryKeyForAddress.class).buildSessionFactory();
		...
		EmployeeHavePrimaryKeyForAddress employee = new EmployeeHavePrimaryKeyForAddress(null, "Gangadhar Panda", officeAddresses);
